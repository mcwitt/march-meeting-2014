...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item But the best known general algorithms have worst-case complexity that
      is exponential in the number of vertices
    \item One of only a few problems in NP not known to be solvable in
      polynomial time or NP-complete (another being factoring)
  \end{itemize}
\end{frame}
\begin{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item Study pair of 13-vertex co-Ising graphs $G_{13}$, $G_{13}'$
