...
\begin{frame}
  ...
  \note{
    \begin{itemize}
      ...
      \item It turns out that all of these are insufficient (vertices, degree
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \item \alert{Hypothesis:} The full \emph{quantum} problem ($0<s<1$) will
...
\begin{frame}
  ...
  \note{
    \begin{itemize}
      ...
      \item Finite-$T$ expectation values?
    \end{itemize}
  }
\end{frame}
